...
export const BidPlaceAndReviewBox: React.FC<BidPlaceAndReviewBoxProps> = (
  props
) => {
            ...
            {closedTime ? (
              <div>
                {new Date(closedTime) < new Date() ? (
                  <p className="text-danger h3 text-align-c mx-3 ">
                    Auction Closed
                  </p>
                ) : (
                  <div>
                    ...
                    <hr />
                    <p className="mt-3">
                      This product will be delivered after the auction closing
                      time.
                    </p>
                    <hr />
                    <Link
        ...
        {isModalOpen && (
          ...
          >
            ...
            >
              ...
              <h3>Place a Bid</h3>
              <label className=" my-1 text-secondary">
                {" "}
                Fill in the details below to place a bid!
              </label>
              <form>
                <div>
                ...
                <div className=" mt-3">
                  <label className=" form-label" htmlFor="bidComment">
                    Comment
                  </label>
                  <input
                    className="form-control"
